...
int main() {
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        // Update and draw GUI.
        gui::do_gui(bs_session.r_feed, bs_session.mode, bs_session.controller_mode, bs_session.last_rover_tick, bs_session.stopwatch_texture_id, bs_session.global_clock, bs_session.r_tp,
        ...
        if (help_menu_up) gui::do_help_menu(&font, commands, debug_commands);
