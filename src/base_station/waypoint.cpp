...
/*****waypoint.cpp****************************************************************
1. rover's coordinates initially set to outside the lat/lon range to indicate the coordinates haven't been updated
2. Adds a waypoint for the rover
3. Returns all waypoints
4. Sets the rovers latitiude and longitude
*********************************************************************************/
